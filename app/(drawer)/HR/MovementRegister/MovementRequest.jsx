...
import { getMovementReasons, submitMovementRequest } from '../../../../services/api';
...
useEffect(() => {
    if (user?.id) {
      setData(prev => ({ ...prev, initiatedBy: user.id,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity>
          <Text style={styles.myMovements}>My Movements</Text>
        </TouchableOpacity>
      </View>
  ...
  >
    {row.map((item, itemIndex) => (
      <View
        ...
        style={[
          styles.inputWrapper,
          row.length > 1 && itemIndex === 0 ? { marginRight: 10 } : {},
        ]}
      >
        ...
        // Date Picker
          ...
          >
            ...
            <Ionicons name="calendar-outline" size={18} color="#777" style={{ marginLeft: "auto" }} />
          </TouchableOpacity>
        ...
        // Time Pickers
          ...
          >
            ...
            <Ionicons name="time-outline" size={18} color="#777" style={{ marginLeft: "auto" }} />
          </TouchableOpacity>
        ) : item.key === "toTime" ? (
          <TouchableOpacity
